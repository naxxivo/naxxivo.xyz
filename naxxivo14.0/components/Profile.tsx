        ...
        const fetchProfile = async () => {
            ...
            try {
                const { data: profileData, error: profileError } = await supabase
                    .from('profiles')
                    .select('id, address, admin, bio, cover_url, created_at, facebook_url, name, photo_url, role, username, website_url, xp_balance, youtube_url')
    ...
    const handleFollowToggle = async () => {
        ...
        try {
            if (isFollowing) {
                ...
                const followData: TablesInsert<'follows'> = { follower_id: session.user.id, following_id: profileIdToFetch };
