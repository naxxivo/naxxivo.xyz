...
import { 
    ...
    Cog6ToothIcon, TvIcon, ShoppingBagIcon, HeartIcon, UserGroupIcon, 
...
const ComponentShowcasePage: React.FC = () => {
    ...
    const pageList: ShowcaseCardProps[] = [
        ...
        { to: '/market', icon: ShoppingBagIcon, title: 'Marketplace', description: 'Buy and sell items within the community.' },
